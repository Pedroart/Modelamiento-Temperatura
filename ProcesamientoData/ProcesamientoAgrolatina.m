...
opts.VariableNames = ["FechaHora", "TemperaturaAmbiente", "AperturaValvula", "Caudal", "EstadoSistema", ...
                      "PresionPall", "TemperaturaRetorno", "SensorZona1", "SensorZona2", "SensorZona3", ...
                      "SensorZona4", "SensorZona5", "SensorZona6", "SensorZona7", "SensorZona8", ...
                      "SensorZona9", "SensorZona10", "SensorZona11", "SensorZona12", "TemperaturaSetpoint", ...
                      "Ventilacion"];
...
varsToClean = ["TemperaturaAmbiente", "TemperaturaRetorno", "SensorZona1", "SensorZona2", ...
               "SensorZona3", "SensorZona4", "SensorZona5", "SensorZona6", "SensorZona7", ...
               "SensorZona8", "SensorZona9", "SensorZona10", "SensorZona11", "SensorZona12"];
...
folderPath = "C:\Users\pedro\Documents\proyectos\Modelamiento-Temperatura\ProcesamientoData\Agrolatina\";
